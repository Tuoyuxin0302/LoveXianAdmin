...
;
layui.define(["laytpl", "laypage", "layer", "form", "util","admin"],
    function(e) {
        "use strict";
        var t = layui.$,
            i = layui.laytpl,
                ...
                if (i.startTime = (new Date).getTime(), a.url) {
                    ...
                    a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)),
                        ...
                        t.ajax({
                            ...
                            headers: a.headers || {},
                            success: function(t) {
                                if( t.code == statusCode.logout){
                                    i.errorView("登录状态失效，请返回登录页认证"),
                                        i.renderForm(),
                                        i.setColsWidth()
                                ...
                                if( t.code == statusCode.elselogin){
                                    i.errorView("由于您的账号在其他地方登录了！此会话已失效"),
                                        i.renderForm(),
                                        i.setColsWidth()
                                ...
                                if(t.code == statusCode.limit){
                                    //被限流了
                                    i.errorView("接口请求太频繁了！稍后再试吧"),
                                        i.renderForm(),
                                        i.setColsWidth()
                                    layer.msg('接口请求太频繁了！稍后再试吧...', {
                            ...
                            error: function(e, t) {
                                ...
                                }else if( e.status == statusCode.elselogin){
                                    i.errorView("由于您的账号在其他地方登录了！此会话已失效"),
                                        i.renderForm(),
                                        i.setColsWidth()
