layui.define(['flow','form','layer','upload','lovexian','element'],function(exports){
    ...
    flow.load({
        elem: '#Images', //流加载容器
            ...
            lovexian.get(proPath+'/admin/shufflingFigure/images',{'sceneId':$('#sceneId').val(),'pageSize':imgNums,'pageNum':page},function (res) {
    ...
    upload.render({
        elem: '.uploadNewImg',
        url: proPath+'/admin/shufflingFigure/uploadImages2',
        multiple: true,
        data:{
            "sceneId":$('#sceneId').val(),
            typeId: function(){
    ...
    $(".batchDel").click(function(){
        ...
        if($checkbox.is(":checked")){
            lovexian.modal.confirm('批量删除图片','确定删除选中的图片？',function(){
                ...
                lovexian.del(proPath+"/admin/shufflingFigure/deleteImages",{"ids":ids.join(",")},function(res){
                    console.log(res);
    ...
    //对外暴露的接口
    exports('shuffle/sceneRotationAdd', {});
