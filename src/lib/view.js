...
layui.define(['laytpl', 'layer'], function(exports){
  ...
  view.req = function(options){
    ...
    if(request.tokenName){
      ...
      //自动给参数传入默认 token
      if(setter.isJwt == false){//jwt不在参数上传递token
    ...
    return $.ajax($.extend({
      ...
      ,success: function(res){
        ...
        if(res[response.statusName] == statusCode.ok || res[response.statusName] == statusCode.success) {
        ...
        }else if(res[response.statusName] == statusCode.elselogin){
